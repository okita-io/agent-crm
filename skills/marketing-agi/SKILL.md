...
One skill, fourteen modules, the full surface a working marketer touches. Built by tearing down the most-starred marketing skill repos on GitHub (48K-star collections down to 100-star craft pieces), keeping what worked, and fixing what every one of them got wrong.
...
- paid-ads → production (an ad-generation MCP is connected, e.g. MaxFusion AI: generate the briefed assets directly — see the production handoff in `paid-ads.md`)
