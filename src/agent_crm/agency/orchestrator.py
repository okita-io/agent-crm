...
from agent_crm.improvement_store import make_fingerprint, record_improvement_note
from agent_crm.jobs.store import count_pending_jobs, count_running_jobs
from agent_crm.models import AgentJob, ContactVerification, Lead
...
def run_orchestrator_cycle() -> None:
    ...
    from agent_crm.jobs.store import reset_stale_running_jobs
...
def run_orchestrator(*, poll_seconds: int | None = None) -> None:
    ...
    from .commands import has_pending_agency_requests, process_pending_agency_requests
