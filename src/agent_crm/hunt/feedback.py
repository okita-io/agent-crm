...
from agent_crm.contacts.extractor import _looks_like_name
from agent_crm.engagement.runner import is_engagement_venue, venue_scan_queries
from agent_crm.enums import Brand, ContactAudience, HuntResourceKind
from .seeds import origin_with_audience
from .store import HuntStore
from .utils import ResourceClassification, normalize_query
...
def is_valid_hunt_handle(platform: str, handle: str) -> bool:
    ...
    from agent_crm.contacts.comment_extractor import is_valid_comment_handle
