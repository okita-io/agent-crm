...
from agent_crm.enums import AgentJobKind, AgentJobStatus, Brand, SPARK_AGENT_JOB_KINDS
...
def enqueue_topical_relevance_job(
    *,
    ...
    from agent_crm.enums import Brand as BrandEnum
    from agent_crm.topic_relevance_store import normalize_url
