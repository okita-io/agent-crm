...
NONPROFIT_QUERIES: dict[Brand, list[str]] = {
    Brand.HEYBUDDY: [
        "SAMHSA loneliness social isolation grant awardee",
        "ACL elder isolation grant award recipient",
        "VA veteran mental health grant awardee nonprofit",
        "Grants.gov social isolation community grant recipient",
        "USASpending caregiver support grant awardee",
        "HHS youth digital wellbeing grant recipient",
        "Administration for Community Living senior isolation grant",
        "HRSA rural mental health grant awardee",
        "Older Americans Act Title III aging agency grant recipient",
        "state aging agency social isolation grant awardee",
        "501c3 federal grant loneliness program partnership",
        "Area Agency on Aging grant award recipient",
        "veteran peer support federal grant awardee organization",
        "CDC social connectedness grant recipient nonprofit",
    ],
}
